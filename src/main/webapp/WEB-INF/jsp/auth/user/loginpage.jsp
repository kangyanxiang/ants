...
<header class="clfix">
    <div class="wrap">
        <div id="logo">
            <i class="icon-logo"></i>
            <div class="platformName">爱WiFi运营管理平台</div>
        </div>
    </div>
</header>
    ...
    <div class="wrap">
        <div class="login-form">
            ...
            <form id="loginForm" name="loginForm" action="<%=request.getContextPath()%>/login_check" method="post">
                <ul>
                    <li><input type="text" class="input" id="username" name="username" placeholder="用户名" value="" tabindex="1" /></li>
                    <li><input type="password" class="input" id="password" name="password" placeholder="密码" value="" tabindex="2" /></li>
                    <li>
					...
					<li><a class="forgetPwdLink" href="<%=request.getContextPath()%>/user/forgetpwdpage">忘记密码</a></li>
