                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            // 计算
                            var maxContentHeight = document.body.clientHeight - 80 * 2; // .ngdialog-theme-default 上下内边距各80px
                            var maxMessageHeight = maxContentHeight - 42; // .ngdialog-header 减去标题高度和下边距
                            // zhuxh 内容高度计算
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-content" role="document" style="max-height:'+maxContentHeight+'px">'+
                                '<div class="ngdialog-header"></div><div class="ngdialog-message" style="max-height:'+maxMessageHeight+'px">' + template + '</div></div>' :
                                '<div class="ngdialog-content" role="document" style="max-height:'+maxContentHeight+'px">'+
                                '<div class="ngdialog-header"></div><div class="ngdialog-message" style="max-height:'+maxMessageHeight+'px">' + template + '</div></div>'));
                            ...
                            // zhuxh 添加标题
                            if (options.title) {
                                var $dialogHeader = $dialog[0].querySelector('.ngdialog-header');
                                if (angular.isString(options.title)) {
                                    $dialogHeader.innerHTML = options.title;
                                }
                            }
                            ...
                            if (options.height) {
                                var $dialogMessage = $dialog[0].querySelector('.ngdialog-message');
                                if (angular.isString(options.height)) {
                                    $dialogMessage.style.maxHeight = options.height;
                                } else {
                                    $dialogMessage.style.maxHeight = options.height + 'px';
                                }
                            }
